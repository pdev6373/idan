...
export const ListingPage = () => {
	...
	return (
		<div className="flex h-screen overflow-hidden">
			...
			<div className="flex flex-col flex-grow p-2 overflow-scroll">
				<div className="flex justify-between items-center mb-4">
					<div className="flex justify-end items-center w-full p-4">
						<div className="flex gap-4 items-center">
							{/* <div className="flex gap-2 items-center">
								<img src={profileImg} alt="" className="w-8 h-8 rounded-full" />
								<h1 className="text-md font-semibold">{auth.firstName}</h1>
							</div> */}
              ...
              {store.auth.firstName} {store.auth.lastName}
				...
				<h1 className="text-center mt-2 text-2xl font-bold">Listing</h1>
				<ListingContainer />
			</div>
		</div>
	);
